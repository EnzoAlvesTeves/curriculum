...
public class CandidatoClient {
    ...
    public CandidatoDTO create(UsuarioDTO CandidatoDTO) throws URISyntaxException {
    ...
    public CandidatoDTO update(UsuarioDTO CandidatoDTO) throws URISyntaxException {
        ResponseEntity<UsuarioDTO> response = restTemplate.exchange(
                new URI(BASE_URL),
                HttpMethod.PUT,
                new HttpEntity<>(usuarioDTO),
